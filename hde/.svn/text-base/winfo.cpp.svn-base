...
static int qcf[] = { qapp::Sticky,qapp::WindowListSkip, qapp::SmallFrame,
		     qapp::NoResize, qapp::NoTile, qapp::NoKey, qapp::NoScreen,
		     qapp::ClassOnly };
...
winfo::winfo(QWidget *parent) : QWidget(parent)
{
  ...
  static const char *qcs[] = { "Sticky","Skip windowlist","Small frame", 
			       "No resize","No tiling", "Skip keyboard access",
			       "Skip in screenmode","Apply to all in class" };
...
void winfo::release_permanent(void)
{
  ...
  int i;
  bool ref=FALSE;
  static const char *qcs[] = { "Sticky", "WindowListSkip", "SmallFrame",
			       "NoResize", "NoTile", "NoKey", "NoScreen" };
  QString ostr;
